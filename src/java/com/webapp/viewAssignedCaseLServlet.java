...
@WebServlet(name = "viewAssignedCaseLServlet", urlPatterns = {"/viewAssignedCaseLServlet"})
public class viewAssignedCaseLServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                "SELECT current_case_cin FROM lawyers where lawyer_name=?");
        ...
        RequestDispatcher rd = request.getRequestDispatcher("viewAssignedCaseL.jsp");
