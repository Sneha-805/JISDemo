...
<head>
    ...
    <title>Judicial Court Login Portal</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="login-container">
        ...
        <form action="LoginServlet" method="post">
            ...
            <input name="uname" id="uname" type="text" placeholder="Enter username" required>

            <label for="pass">Password</label>
            <input name="pass" id="pass" type="password" placeholder="Enter password" required>

            <button type="submit" name="smt">Login</button>
